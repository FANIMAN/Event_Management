                        ...
                        <div class="flex flex-row gap-2 items-center ">
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                ...
                                <path
                                    ...
                                    stroke="#D3AF35" stroke-width="1.1" stroke-linecap="round"
                                    stroke-linejoin="round" />
                                <path d="M9.89996 4.94995V14.85" stroke="#D3AF35" stroke-width="1.1"
                                    stroke-linecap="round" stroke-linejoin="round" />
                                <path
                            ...
                            <select v-model="ticketPrice" @change="handleTicketPriceChange"
                                class="text-[#171625] font-bold flex justify-center items-center bg-white rounded-md">
